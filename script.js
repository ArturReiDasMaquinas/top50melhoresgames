const games = [
    ...
    // Adicione os outros jogos seguindo o padrão...
    ...
    { title: "Assassins Creed II", genre: "Aventura" },
    { title: "Forza Horizon 5", genre: "Corrida" },
    { title: "Mario Kart 8", genre: "Corrida" },
    { title: "Age of Empires II", genre: "Estratégia" },
    { title: "Alan Wake 2", genre: "Terror" },
    { title: "It Takes Two", genre: "Co-op" }
    // (A lista continua até 150 conforme as versões anteriores enviadas)
];

// O resto do código (Busca e Sorteio) permanece igual para garantir funcionamento
